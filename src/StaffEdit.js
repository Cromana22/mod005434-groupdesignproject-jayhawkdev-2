    ...
    <div className="staff">
      ...
      <div className="EditStaffForm AddStaffForm d-flex add-staff-container">
        ...
        <form method="POST" action={phpUrl + "/staffedit.php"}>
          ...
          <input className="wider" id='add-staff-inp' type='text' name='firstName' defaultValue={details.firstName} required></input><br />
          <label>Surname: </label>
          <input className="wider" id='add-staff-inp' type='text' name='surname' defaultValue={details.surname} required></input><br />
          <label>Job Title: </label>
          <input className="wider" id='add-staff-inp' type='text' name='jobTitle' defaultValue={details.jobTitle} required></input><br />
          <label>Shop: </label>
          <input className="wider" id='add-staff-inp' type='text' name='shopName' defaultValue={details.shopName} ></input><br />
          <label>Department: </label>
          <input className="wider" id='add-staff-inp' type='text' name='deptName' defaultValue={details.deptName} ></input><br />
          <label className="product-resp-inp">Product Responsibilities: </label>
          <Form.Select className="wider product-resp-inp" id='product-resp-inp' multiple aria-label="Default select Product Type" name='productTypes[]' defaultValue={products}>
            <option value="T" >Toys</option>
            <option value="G" >Gadgets</option>
          </Form.Select><br />
          <label>Access Level: </label>
          <Form.Select className="wider" id='title-inp-p' aria-label="Default select Access Level" defaultValue={details.accessLevel} name='accessLevel' required >
